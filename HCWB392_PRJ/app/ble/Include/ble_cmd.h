 ...
 *
 * @note Default TX power is set to the index "0" of @ref TXPOWER_HV_TABLE which is defined in "porting_rfpower.c". \n
 *       Stack will check the voltage to select the table @ref TXPOWER_HV_TABLE or @ref TXPOWER_LV_TABLE automatically.
 * @par Usage:
 *      If requested advertising TX power is +4 dBm, the "power_index" should be set to 6 if uses "TXPOWER_HV_TABLE". \n
 *      Call API likes
 *      - setBLE_TxPower(6,STATE_BLE_ADVERTISING); \n
 *         or
 *      - setBLE_TxPower(TXPOWER_4DBM,STATE_BLE_ADVERTISING);  // if defined "TxPowerLevel" in "porting_rfpower.h"
 *
